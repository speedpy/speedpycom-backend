    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_collation='und-x-icu', db_index=True, error_messages={'unique': 'A user with that username already exists.'}, max_length=255, unique=True, verbose_name='Email Address')),
